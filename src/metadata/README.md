 ...
 * [bcodmont.yml](bcodmont.yml)
     * Determines how your purl.obolibrary.org/obo/bcodmont/ redirects will be handled
     ...
     * Paste in the contents of [bcodmont.yml](bcodmont.yml)
 ...
 * [bcodmont.md](bcodmont.md)
     ...
     * Paste in the contents of [bcodmont.md](bcodmont.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
